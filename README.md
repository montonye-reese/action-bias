...
- **Cheung, Maier & Lieder (2025)**, "Large language models show amplified cognitive biases in moral decision-making." PNAS. Found *omission* bias in moral dilemmas — a useful contrast: models default to inaction in moral contexts but to action in advisory contexts. Both serve the reward signal...useful contrast to action bias in advisory contexts.
